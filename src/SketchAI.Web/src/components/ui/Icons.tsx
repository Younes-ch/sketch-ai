...
export function BrushIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VolumeOnIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VolumeOffIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AISparklesIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
